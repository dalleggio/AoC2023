...
def traverse(optics_arr, start_row, start_col, start_dir):
    stack = []
    visited = []
    energized = np.zeros(optics_arr.shape)
    r = start_row
    c = start_col
    dir = start_dir
    while True:
...
for c in range(num_cols):
    energized = traverse(optics_arr, 0, c, 'd')
...
# Bottom row
for c in range(num_cols):
    energized = traverse(optics_arr, num_rows - 1, c, 'u')
    if energized > max_energized:
        max_energized = energized
    print(num_rows - 1, c, energized)

# Left col
for r in range(num_rows):
    energized = traverse(optics_arr, r, 0, 'r')
    if energized > max_energized:
        max_energized = energized
    print(r, 0, energized)
...
# Right col
for r in range(num_rows):
    energized = traverse(optics_arr, r, num_cols - 1, 'l')
    if energized > max_energized:
        max_energized = energized
    print(num_cols - 1, r, energized)
